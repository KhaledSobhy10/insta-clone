...
import { getValue, addValue, removeValue } from "../helpers/local-storage";

// import logo from "../images/instagram-2.svg";
import moon_icon from "../images/moon-icon.png";
...
function Header() {
  ...
  return (
    <header className="sticky top-0 bg-white text-white flex justify-center items-center  p-3  border-b-2	dark:border-slate-600	 w-full z-50 dark:bg-slate-800	">
      <div className="container flex justify-between items-center ">
        ...
        <div className="flex text-black items-center gap-2	">
          {user ? (
            <>
              <Link to={ROUTES.HOME} aria-label="Home">
                <svg
                  className="w-8 mr-6 text-black-light dark:text-[#FAFAFA] cursor-pointer"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
          ...
          >
            {darkMode ? (
              <img src={moon_icon} alt="dark theme" />
            ) : (
              <img src={sun_icon} alt="light theme" />
            )}
          </button>
        </div>
      </div>
